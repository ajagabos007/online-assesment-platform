            ...
            <div class="row">
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <input type="datetime-local" name="bdate" id="bdate" class="form-control" placeholder="Enter date of birth" autocomplete="off" >
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder=""  autocomplete="off" pattern="^(\+234)[0-9]{10}$" required="">
                </div>
              </div>
            </div>
            <div class="form-group">
